...
label pcbang:
    ...
    menu:
        "PC방에 같이 가서 게임을 한다":
            ...
            Mirae "우리끼리 대전하는게 재밌지 않아? 서로 경쟁하고 내기도 할수 있고!"
            Daehyun "난 다 좋아 ㅋㅋ 뻔대야 넌 뭐하고 싶어?"
            ...
            menu:
                "'리그 오브 전설'을 한다":
                    ...
                    Jinil "아 니네들 진짜 뭐하냐. 뻔대 너는 내가 숟가락을 입에 넣어줘도 못 받아먹네.\n
                    게임 하고 싶은거 맞아?"
                    Mirae "왜 그래 진일아... 그냥 게임 이잖아"
                ...
                "'쇼핑카트 라이더'를 한다":
                    ...
                    Mirae "후후후 난 심지어 면허도 있다고 이 무면허들아~"
                    Daehyun "너 장롱면허잖아 ㅋㅋㅋㅋ"
                    Mirae "없는것 보단 낫거든~"
                    Jinil "ㅋㅋ"
                    Daehyun "진일아 얼른 들어와"
