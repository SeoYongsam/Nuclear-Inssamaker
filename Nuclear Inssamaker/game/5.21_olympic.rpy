...
label olympic:
    ...
    Jangjung "뻔대야\n"
    extend "나는 언제 들어가??"
    Jangjung "나 10시부터 왔는데 계속 벤치에만 있다\n"
    extend "나도 뛰고 싶어"
    ...
    #         Player "참여한다고 한 친구가 남친이 못하게 한다네요 ㅠㅠ\n"
    #         extend "정말 죄송합니다..."
    #         "심리학과 과대" "그건 좀 곤란한데...\n"
    ...
    menu:
        ...
        "거절한다":
            ...
            Player "또 달리기 이기면 어떻고 지면 어떠냐 ㅋㅋㅋㅋ\n"
            extend "재밌게 놀다가면 되지"
            Jinil "아니... 내가 우리과가 밀릴 줄 알았냐\n"
            extend "너는 자존심도 안 상해?"
            Jinil "이것도 지면 얘들이 얼마나 쪽팔리겠냐?\n"
            extend "어휴 난 모르겠다..."
            #진일 -, 과 -
            $ jinil.parameter -= 10
            $ gwa_parameter -= 2
    ...
    Player "다들 바빠서 뒤풀이는 별로 못와서 아쉽지만,\n"
    extend "온 사람들끼리라도 한 잔 하자!!"
    Jinil "그래 뻔대도 고생 많았다"
    Player "내가 문정과하면 너희들이 가즈아~~해줘!!!\n"
    extend "문정과~~"
    "진일, 장중" "가즈아~~~"
    Player "와... 근데 진짜 뒤풀이 온 사람이 너무 없네\n"
    ...
    Player "학기말 되고나서부터 다들 바빠지니깐\n"
    extend "과 행사 기획하고 추진하는 일은 내가 다 하고\n"
    extend "도와주는 사람들은 없으니깐 너무 지친다"
    Player "아 모르겠다...\n"
