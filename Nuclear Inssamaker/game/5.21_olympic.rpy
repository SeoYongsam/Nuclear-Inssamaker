...
label olympic:
    ...
    Player "다들 바빠서 뒷풀이는 별로 못와서 아쉽지만,\n"
    ...
    Player "나도 학기말 되고 다들 바빠지고 이러면서 과 행사 기획하고 추진하는 일 다 내가 주로 하고 도와주는 사람들도 없는데 너무 지친다"
    Player "아 모르겠다....\n"
    extend "다 내 능력이 부족해서 그런가보다"
    Player "요즘 일하다가 공부도 잘 못하고, 동아리도 잘 못하고, 잠도 잘 못자고 너무 지친다\n"
