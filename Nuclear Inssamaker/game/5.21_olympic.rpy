...
label olympic:
    ...
    "주인공" "오늘 날씨 진짜 좋다!!! 오늘 심리학과 발라버리자~~\n"
    "진일" "가즈아~~~~\n"
    "장중" "오늘 경기 뭐뭐한댔지?"
    "주인공" "오늘 축구랑 피구, 계주할거야 ㅋㅋㅋ\n"
    extend "벌써 11신데....\n"
    extend "온다는 얘들이 좀 늦네...."
    "진일" "걔들 좀 늦는데 ㅋㅋㅋ\n"
    ...
    menu:
        "들어준다":
            ...
            "현재" "우리가 0이야\n"
            extend "쟤네들 생각보다 잘하네"
            "주인공" "아 그러면 우리 분위기 전환이 필요할 것 같지 않아?\n"
            extend "장중이 넣는건 어때?"
            "현재" "아... 장중이는 좀...\n"
    ...
    menu:
        "들어준다":
            show playground at truecenter
            "진일" "내가 진짜 열심히 뛰어서 우리 팀 우승 시킬게"
            "SYSTEM" "엔트리 제출"
            "장중" "야\n"
            extend "내가 왜 마지막 주자 아니야?\n"
            extend "김진일이 마지막이네?\n"
            extend "어이가 없네"
            "주인공" "우리 운동회 지고 있으니까 이거라도 이겨야지\n"
            extend "진일이가 제일 빠르잖아\n"
            extend "네가 이해 좀 해줘..."
            "장중" "아 진짜 이럴거면 왜 뽑은거야 ㅅㅂ"
            #진일 +, 장중 -, 과 -
            $ jinil.parameter += 20
            $ jangjung.parameter -= 20
            $ gwa_parameter -= 10
    ...
    "진일" "그래 뻔대도 고생 많았다"
    "주인공" "내가 문정과하면 너희들이 가즈아~~해줘!!!\n"
    extend "문정과~~"
    "진일, 장중" "가즈아~~~"
    "주인공" "와... 근데 진짜 뒷풀이 온 사람이 너무 없네\n"
    extend "너네라도 있어서 다행이다"
    "장중" "그러니까 우리한테 잘하라고 ㅋㅋㅋ"
    "주인공" "에이 내가 너네들한테 얼마나 잘하는데 ㅋㅋㅋ"
    "장중" "음... 솔직히 말하면 나는 요즘 너한테 섭섭해\n"
