    ...
    if month == 3 :
        ...
        if week == 1 :
            ...
            if day == 1 :
                ...
                # 장발 마감 했을 시
                $ samyong.add("날짜|4월 5일 목요일")
                $ samyong.add("삼용|오오오오오 드디어 내일!! 두근두근")
                $ samyong.add("주인공|ㅋㅋㅋㅋㅋㅋㅋㅋ 기대 된다!!")
                $ samyong.add("삼용|ㅇㅇ 진짜 ㅋㅋㅋ 내일 장발도 있으니까")
            ...
            if day == 3 :
                ...
                $ samyong.add("삼용|음...내가 너무 단톡에서 중간고사 얘기 밖에 안하나..?")
            ...
            if day == 3 :
                $ samyong.add("삼용|뻔대야 너도 야식 ㄱㄱ??")
                $ samyong.add("연속|치킨 먹는대 ㅋㅋㅋ")

            elif day == 6 :
                $ samyong.add("삼용|우리 월요일에 장보는거 맞지?")
                $ samyong.add("주인공 |ㅇㅇ 장터가 화요일이니까 그 전날!!")
                $ samyong.add("삼용|아 ㅇㅋㅇㅋ 잘못알고 있나 해서 ㅋㅋㅋ")
        ...
        if week == 1 :
            if day == 0 :
                ...
                $ samyong.add("삼용|나 수업 끝났다")
                $ samyong.add("연속|지금 갈게!!!")
                $ samyong.add("주인공|엉엉 ㅋㅋㅋ 얼른 와!!!")

            elif day == 3 :
                $ samyong.add("날짜|5월 4일 수요일")
                $ samyong.add("삼용|우리 돈 어제 뒷풀이에서 진짜 다 썼어??")
                $ samyong.add("주인공|나도 모르겠다 ㅠㅠ 한번 봐야할 것 같아")
        ...
        if week == 1 :
            if day == 0 :
                ...
                $ samyong.add("삼용|너 어제 못와서 아쉽 ㅠ")
                $ samyong.add("연속|동아리 끝나면 한 잔 해")

            elif day == 2 :
                $ samyong.add("날짜|6월 3일 화요일")
                $ samyong.add("삼용|네 공연 보러가자는 얘들이 없네 ㅠ")
            ...
            if day == 0 :
                ...
                $ samyong.add("삼용|우리 종파 언제지?")

            elif day == 6 :
                $ samyong.add("날짜|6월 21일 토요일")
                $ samyong.add("삼용|나는 좀 늦게 갈 것 같아")
