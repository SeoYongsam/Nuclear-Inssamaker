...
label club_concert :
    ...
    if club_parameter >= 50 :
        ...
        Player "그만해라 부끄럽다 ㅋㅋㅋ\n"
        extend "니도 기타 솔로 장난 아니더만"
        Dongah "아무튼 오늘 공연정리 끝나고 밴드 애들이 시간되면 놀자는데\n"
        extend "과 친구들 만나고 가능하면 우리 보러 온나"
        Player "알겠다 ㅋㅋ"
    ...
    #공연 실패
        ...
        Dongah "수고했다 ㅋㅋ"
        Player "미안...\n"
        extend "니랑 동아리원들 다 열심히 준비했는데\n"
        extend "내가 실수 많이 해서 공연 망친 것 같네..."
    ...
    if club_parameter <= gwa_parameter:
        ...
        Ohduck "후훗"
        Jangjung "진짜 수고했다 뻔대야 ㅋㅋㅋ\n"
        extend "동아리 공연도 이제 끝이니까 우리랑도 놀아줘라~"
        ...
        "애들이 많이 공연보러 와서 감동이었다.\n내가 그래도 과생활은 열심히 했다는 생각이 들었다."
    ...
    #동아리 공연에 사람이 거의 안옴
        ...
        Samyong "장중이랑 진일이는 보다가 중간에 갔고\n"
        extend "다른 애들은 바쁘다고 못왔어..."
        Player "아… 그래도 너라도 와줘서 고마워 삼용아"
        Samyong "그래 ㅋㅋㅋ 이제 동아리 공연도 끝났으니깐\n"
        extend "동아리 말고 과에도 조금 더 신경써줘~"

        "심용이 말고는 아무도 공연을 끝까지 보러 오지 않아서 슬펐다."
        "과생활을 열심히 한다고 했지만 충분하지 않았나보다.\n오늘은 조금 외롭다."

        $ mental_point -= 30

    #동아리 파라미터 일정 이하면 동아리 활동 사라짐
    if club_parameter < 50 :
        "내가 공연을 망친 것 같아서 더 이상 동아리에 나가기가 부끄럽다.\n당분간 동아리에는 못 갈 것 같다."
        $ club_open = False
