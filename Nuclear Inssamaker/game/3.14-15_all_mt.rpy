...
label all_mt:
    ...
    "장을 다 보고 나서는 근처 식당에서 다같이 점심을 먹기로 했다.\n이후 짐을 나눠들어 MT장소까지 가는 버스를 타러 가기로 했다."
    ...
    menu:
        "진일이 옆":
            ...
            Jinil "한눈에 알아보고 인싸 자리에 앉았네 뻔대?  역시 사람 볼줄 알아~ 우리 지금부터 한잔 하는거 어때 ㅋㅋㅋ"
        ...
        "장중이 옆":
            ...
            Player "벌써부터 다음에 놀거 생각하고 있어?? 대단하다..."
        ...
        "삼용이 옆":
            ...
            Samyong "야야 여기 얼른 와봐!"
            Player "응? 무슨일이야?"
            Samyong "지금 현재랑 미래 같이 앉은거 보여? 저 둘 수상해~"
    ...
    menu:
        ...
        "고기 굽기":
            ...
            Jinil "마침 사람 부족했는데 잘됐다. 뻔대야 여기 와서 같이 고기나 굽자"
            Player "뭐야 여기 왜 사람이 너 밖에 없어?"
            Jinil "몰라 다들 고기 굽기 싫어서 식기 셋팅하러 빠진것 같은데. 저기봐봐 식기 셋팅하는데 무슨 20명이나 가있냐"
            Player "그렇네 ㅋㅋ..."
            Jinil "너라도 여기 와서 그래도 좀 낫네. 역시 뻔대는 다르다"
        ...
        "밥/반찬 준비하기":
            ...
            Player "나 방금!"
            Samyong "잘됐다. 그러면 내가 밥 퍼서 애들한테 전달할테니까 넌 여기서 김치 좀 썰고있어. 혼자 하려니까 너무 힘드네"
            Player "알겠어!"
    ...
    Player "응? 그게 무슨말이야…\n내가 뭐했...웁…."
    Jangjung "야 화장실 가서 토해! 여기다 토하지 말고!!!"
    Player "우웩… 아… 나 어제 도대체 얼마나 마신거냐"
    Jinil "너 어제 레크레이션 하다가 신나서 선배들이랑 술 엄청 마셨어 ㅋㅋㅋㅋ"
    Samyong "선배들이 너 술 잘마신다고 계속 먹이다가 너 취해서 들여 보냈어 ㅋㅋㅋㅋ"
    Player "술 취했다고? 어떻게?"
    Samyong "기억 진짜 안나? 너 뻔대라고 우리 과 애들 다 책임지겠다고 하다가 갑자기 막 푸쉬업하고 술 계속 원샷하고 난리였어 ㅋㅋㅋㅋ"
    Jinil "진짜 상남자 ㅋㅋㅋ 내가 인정 잘 안하는데 인정한다 뻔대야"
    Jangjung "믿을만하다 뻔대!!!"
    Samyong "일단 우리 여기 정리하고 갈 준비하자"
    Jangjung "맞아 사람들 이미 다 가고 몇명 안남았어"
    ...
    menu:
        "해장하러 간다":
            ...
            Jangjung "그치 ㅋㅋㅋ 여기 잘온듯"
            Player "으아~ 너무 좋다. 이제 집에가서 쉴 일만 남았다"
            Jangjung "아 나도 이제 빨리 집 가고 싶다"
            Jinil "오늘 쉬고 밤에 또 술 ㄱㄱ?"
            Samyong "진심이야??"
            Jinil "난 진짜 마셔도 좋은데 ㅋ"
            Jangjung "아 노노 난 불가능"
            Player "나도 불가능 할듯 ㅋㅋ 오늘은 좀 쉬어야지"
            Jinil "다들 술 약해서 어떡하냐~ 어쩔수 없지"
            Samyong "이제 가자"
