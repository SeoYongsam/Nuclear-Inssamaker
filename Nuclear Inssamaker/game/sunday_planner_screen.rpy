    ...
    if day_schedule[month_for_display][8] != 0:
        hbox:
            ...
            if day_schedule[month_for_display][8] == 1:
                add im.Alpha(im.MatrixColor("planner/sel_study.png",im.matrix.saturation( 0.1+((2/week) * ((month_for_display+3)/month)))), 0.8)

            elif day_schedule[month_for_display][8] == 2:
                add im.Alpha(im.MatrixColor("planner/sel_club.png",im.matrix.saturation( 0.1+((2/week) * ((month_for_display+3)/month)))), 0.8)

            elif day_schedule[month_for_display][8] == 3:
                add im.Alpha(im.MatrixColor("planner/sel_gwa.png",im.matrix.saturation( 0.1+((2/week) * ((month_for_display+3)/month)))), 0.8)

            elif day_schedule[month_for_display][8] == 4:
                add im.Alpha(im.MatrixColor("planner/sel_rest.png",im.matrix.saturation( 0.1+((2/week) * ((month_for_display+3)/month)))), 0.8)
    ...
    if day_schedule[month_for_display][15] != 0:
        hbox:
            ...
            if day_schedule[month_for_display][15] == 1:
                add im.Alpha(im.MatrixColor("planner/sel_study.png",im.matrix.saturation( 0.1+((3/week) * ((month_for_display+3)/month)))), 0.8)

            elif day_schedule[month_for_display][15] == 2:
                add im.Alpha(im.MatrixColor("planner/sel_club.png",im.matrix.saturation( 0.1+((3/week) * ((month_for_display+3)/month)))), 0.8)

            elif day_schedule[month_for_display][15] == 3:
                add im.Alpha(im.MatrixColor("planner/sel_gwa.png",im.matrix.saturation( 0.1+((3/week) * ((month_for_display+3)/month)))), 0.8)

            elif day_schedule[month_for_display][15] == 4:
                add im.Alpha(im.MatrixColor("planner/sel_rest.png",im.matrix.saturation( 0.1+((3/week) * ((month_for_display+3)/month)))), 0.8)
    ...
    if day_schedule[month_for_display][22] != 0:
        hbox:
            ...
            if day_schedule[month_for_display][22] == 1:
                add im.Alpha(im.MatrixColor("planner/sel_study.png",im.matrix.saturation( 0.1+((4/week) * ((month_for_display+3)/month)))), 0.8)

            elif day_schedule[month_for_display][22] == 2:
                add im.Alpha(im.MatrixColor("planner/sel_club.png",im.matrix.saturation( 0.1+((4/week) * ((month_for_display+3)/month)))), 0.8)

            elif day_schedule[month_for_display][22] == 3:
                add im.Alpha(im.MatrixColor("planner/sel_gwa.png",im.matrix.saturation( 0.1+((4/week) * ((month_for_display+3)/month)))), 0.8)

            elif day_schedule[month_for_display][22] == 4:
                add im.Alpha(im.MatrixColor("planner/sel_rest.png",im.matrix.saturation( 0.1+((4/week) * ((month_for_display+3)/month)))), 0.8)
