    ...
    if month == 3 :
        ...
        if week == 1 :
            ...
            if day == 0 :
                ...
                $ fbook_post_add("댓글시작")
                $ fbook_post_add("댓글|해장중|문정과 좋아 랄랄라라~")
                $ fbook_post_add("댓글종료")
                $ fbook_post_add("그림자")
                $ fbook_count += 1
        ...
        if week == 1 :
            ...
            if day == 1 :
                ...
                $ fbook_post_add("본문|해장중|2019년 5월 21일|과 대항 운동회 뒤풀이 중 ㅋㅋㅋ운동하고 술 마시기 개꿀잼 ㅋㅋㅋㅋ옆에 술찌 뻔대 꼴아있음 ㅋㅋㅋㅋ")
                $ fbook_post_add("그림자")
                $ fbook_count += 1

        elif week == 4 :
            if day == 0 :
                $ fbook_post_add("본문|해장중|2019년 5월 22일|어제 운동회 뒤풀이는 역대급이었다다양한 종목들로 다른 과와 경쟁하고, 뒤풀이에서 화합의 장까지!또 했으면 좋겠다 ㅋㅋㅋ뻔대 꼴아서 쓰러진 모습 사진 올릴까 고민하다 참음ㅋㅋㅋ다음엔 여명 마시고 오자 ㅋㅋㅋ")
                $ fbook_post_add("그림자")
                $ fbook_count += 1

            elif day == 3 :
                $ fbook_post_add("본문|유현재|2019년 5월 25일|관악 최고 테니스 동아리 임팩트사람들하고 대회 끝나고 뒤풀이 중 ㅋㅋㅋ이번에 종합체육대회 우리가 종합우승!다음엔 나도 열심히 해서 A팀 멤버로 뛰어야지~")
                $ fbook_post_add("그림자")
                $ fbook_count += 1
        ...
        if week == 1 :
            ...
            if day == 0 :
                ...
                $ fbook_post_add("본문|김진일|2019년 6월 12일|누구인가? 지금 누가 종강소리를 내었어? 누가 종강소리를 내었는가 말이야!!\n참으로 딱하구나! 저 자의 머릿속에는 마구니가 가득하다! 과제로 때려 죽여라.")
                $ fbook_post_add("댓글시작")
