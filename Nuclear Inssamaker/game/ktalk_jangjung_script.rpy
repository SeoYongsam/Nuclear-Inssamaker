    ...
    if month == 3 :
        if week == 2 :
            ...
            if day == 1 :
                ...
                $ jangjung.add("장중|야 우리 진짜 과잠 맞추자")

            elif day == 2 :
                $ jangjung.add("날짜|3월 17일 화요일")
                $ jangjung.add("장중|너 미팅 해봤냐?? ㅋㅋㅋㅋ")
        ...
        if week == 1 :
            ...
            if day == 2 :
                ...
                $ jangjung.add("장중|좋지좋지 곧 나감 ㄱㄷ")
                $ jangjung.add("주인공|ㅇㅋㅇㅋ")

        elif week == 4 :
            if day == 0 :
                $ jangjung.add("장중|우리 과도 장터 하지??")
                $ jangjung.add("주인공|아마 그럴 것 같은데?")
                $ jangjung.add("장중|아 ㅇㅋㅇㅋ")
        ...
        if week == 1 :
            if day == 0 :
                ...
                $ jangjung.add("장중|우리 내일 장보러 몇시에 가?")
            ...
            if day == 3 :
                ...
                $ jangjung.add("장중|우리 운동회 종목 뭐뭐있어?")
                $ jangjung.add("주인공|아직 다른반이랑 얘기 안해봐서 모르겠네")
                $ jangjung.add("장중|막 뛰는거나 그런것 밖에 없으려나")
                $ jangjung.add("주인공|하고 싶은거 있어??")
                $ jangjung.add("장중|나 그냥 운동을 별로 안좋아함 ㅋㅋㅋ")

            elif day == 6 :
                $ jangjung.add("날짜|5월 14일 토요일")
                $ jangjung.add("장중|오늘 밤에 술 ㄱㄱ?")

        elif week == 3 :
            if day == 0 :
                $ jangjung.add("날짜|5월 15일 일요일")
                $ jangjung.add("장중|뻔대야 우리 꼭 뒷풀이 다른 과 애들이랑 같이 해야돼?")
                $ jangjung.add("연속|나는 그냥 우리끼리 마셨으면 좋겠는데")

            elif day == 1 :
                $ jangjung.add("장중|김진일 백퍼 갠톡해서 우리 뭐라했지?")
                $ jangjung.add("연속|나한테도 왔더라 ㅋㅋㅋ")

            elif day == 5 :
                $ jangjung.add("날짜|5월 20일 금요일")
                $ jangjung.add("장중|내일 둘이 한 잔 하자... 할 말도 있고")

        elif week == 4 :
            if day == 0 :
                $ jangjung.add("날짜|5월 22일 일요일")
                $ jangjung.add("장중|와... ㅅㅂ")
