...
label friend_2:
    ...
    Player "ㅎㅎㅎ 고마워! 너도 많이 고생했으니 너도 한 잔 받아"
    Player "후 그래도 걱정 나름 많았는데, 다들 뻔엠 즐기고 있는 것 같아서 다행이다.."
    Samyong "뭐 전부 너가 뒤에서 열심히 해서 그런거 아닐까"
    Samyong "진짜 고생 많았어!!"
    Player "에이 나 혼자만 한 건 아니지..너나 장중이나 진일이처럼 꾸준히 도와준 애들이 있어서 그랬던 거니까.."
