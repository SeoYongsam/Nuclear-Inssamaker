...
#        Player "퀴즈가 너무 어려웠다."
#        if study_parameter <= 3.2*4 :
#            extend "그래서 망친 것 같다."
#            # 멘탈 하락
#            "멘탈이 터졌다"
#            $ mental_point -= 40

#        elif study_parameter < 3.2*8 :
