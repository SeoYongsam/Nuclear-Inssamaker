    ...
    if month == 3 :
        if week == 1 :
            if day == 3 :
                ...
                $ dongah.add("동아|마 니 뻔대도 하고 잘나가대? ㅋㅋㅋㅋㅋ")
                ...
                $ dongah.add("동아|오~동소제? 이번에도 동아리 함 같이 할까?")
                $ dongah.add("주인공|당연하제~ㅋㅋㅋㅋㅋㅋ 그래도 니랑 내랑 인연이 몇 년인데")
                $ dongah.add("주인공|이 학교에서도 공연 계속 같이해야지!")
                $ dongah.add("동아|오키오키! 그럼 다음주 월욜날 어디 들어갈지 돌아다녀보면서 정하자.")
                $ dongah.add("동아|괜찮제?")
            ...
            if day == 0 :
                ...
                $ dongah.add("동아|야~죽었나?ㅋㅋㅋㅋ")
                $ dongah.add("동아|내일 동소젠거 알제?")
                $ dongah.add("주인공|당연하짘ㅋㅋㅋㅋ 설마 내가 까먹었겠냨ㅋㅋㅋㅋ")
                $ dongah.add("동아|에이 혹시 모른다이갘ㅋㅋㅋㅋㅋ")
                $ dongah.add("동아|그래서 물어봤지")
                $ dongah.add("주인공|당연히 기억하지, 그래 내일 몇 시에 볼까?")
                $ dongah.add("동아|니 수업 몇 시에 끝나는데?")
                $ dongah.add("동아|난 12시 반쯤")
                $ dongah.add("주인공|아;; 난 1시 쯤에 끝나는데;;")
                $ dongah.add("동아|글나..음 그럼 내가 먼저 가서 둘러보고 있을게")
