...
label dongsoze:
    ...
    Player "어 동아다! 하요하요!"
    Dongah "오 뻔대 친구 아이가? 바쁜 친구가 그래도 오긴 왔네?"
    Player "그래도 약속했는데 당연히 와야지! 근데 니가 왜 여기서 기타치고 있냐?"
    Dongah "음? 그냥 이리저리 둘러보다가 여가 제일 분위기 좋아보여서, 저 짝에 있는 선배랑 얘기하다보니까 자연스럽게? 일케 됐다."
    ...
    "동아리 선배" "와 새내기 노래 진짜 잘 부르시네요. 혹시 밴드에 관심있어요?"
    "동아리 선배" "새내기 정도면 저희쪽에서 스카웃 하고 싶은데, 혹시 저희 동아리 들어와 주실 수 있나요??"
    Player "아..네 뭐...친구도 있고 하니까 된다면 들어갈게요."
    "동아리 선배" "와!! 잘 선택하셨어요!! 당장 이번주 목요일이 이번 학기 첫 정기 연습이니까 꼭 와주세요~!"
    Player "아 네넵! 그럼 그 날 뵙겠습니다!"
