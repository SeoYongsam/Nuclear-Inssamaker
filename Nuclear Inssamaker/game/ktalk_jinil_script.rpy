    ...
    if month == 3 :
        ...
        if week == 1 :
            ...
            if day == 2 :
                ...
                $ jinil.add("진일|아 영화보니까 괜히 코노 가고 싶네")
                $ jinil.add("연속|시험 끝나고 함 가실??")
                $ jinil.add("주인공|엌ㅋㅋㅋㅋㅋㅋ 나야 좋지")
                $ jinil.add("주인공|날 잡아!!")
                $ jinil.add("진일|무슨 코노에 날까지 잡냨ㅋㅋ 그냥 땡기면")
        ...
        if week == 1 :
            if day == 0 :
                ...
                $ jinil.add("진일|애들 왤케 안오냐...")
                $ jinil.add("주인공|나도 모르겠다...")

            elif day == 3 :
                $ jinil.add("날짜|5월 4일 수요일")
                $ jinil.add("진일|어제 너무 많이 마셨다 ㅋㅋㅋㅋ")
                $ jinil.add("연속|죽을것 같다")
            ...
            if day == 4 :
                ...
                $ jinil.add("진일|애들 왜이렇게 투표 안하냐")
                $ jinil.add("연속|쪼아봐 ㅋㅋ")

            elif day == 6 :
                $ jinil.add("날짜|5월 14일 토요일")
                $ jinil.add("진일|밤에 장중이랑 술 ㄱㄱ?")
            ...
            if day == 1 :
                ...
                $ jinil.add("진일|동아리 가서 잘하고 있어 ㅋㅋㅋ")
        ...
        if week == 1 :
            if day == 0 :
                ...
                $ jinil.add("진일|나는 공연 보러 못 갈 것 같다")
                $ jinil.add("연속|미안미안")
